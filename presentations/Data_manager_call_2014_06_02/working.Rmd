...
```{r first_attempt_success_adult, eval=FALSE, fig.path="figures/", include=TRUE, fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
## Adult DASH-1A
```{r DASH1A_adult, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r RSI_compliance, include=TRUE,  fig.path="figures/", fig.height=3, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
## HEMS Over-triage
```{r hems_over_triage, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
## STEMI Bedside
```{r bedside_stemi, fig.cap="",  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
rate.overall <- weighted.mean(mydata$mean_bedside_stemi, mydata$stemi_cases, na.rm=TRUE)

metric.table <- plot.metrics.wm(
    "Average bedside time for 
STEMI activation patients",
                             group = bedside_stemi$group,
...
## STEMI Scene
```{r scene_stemi, fig.cap="",  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r ecg_stemi, include=TRUE,  fig.path="figures/", fig.cap="Data only reported for one  month by 1 program", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r bg_check, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r htn_hem_stroke, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r hem_shock_managed, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r bp_aortic, include=TRUE,  fig.path="figures/", fig.height=2.5, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
1. Local infrastructure & tracking 
2. Enter Data in GAMUT database
3. Develop run-charts (trends)
4. Grow participation 
5. Improve Patient Care / Safety
