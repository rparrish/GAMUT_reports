...
plotData <- metricData[metricData$adult_adv_airway_cases > 0 & metricData$adult_adv_airway_cases >= metricData$adult_adv_airway_capno,
                       c("group", "adult_adv_airway_capno", "adult_adv_airway_cases")]
colnames(plotData) <- c("group", "num", "den")
...
```{r bg_check, include=TRUE,  fig.path="figures/", fig.height=4, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r htn_hem_stroke, include=TRUE,  fig.path="figures/", fig.height=4, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
...
```{r bp_aortic, include=TRUE,  fig.path="figures/", fig.height=4, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
