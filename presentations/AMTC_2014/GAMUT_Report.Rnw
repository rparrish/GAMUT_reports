...
<<r vent_adv_airway, include=TRUE, fig.height=8, figeval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=

variables <- c("group", "adv_airway_ventilator", "adv_airway_cases")

gamutplot("Percent of patient transport contacts with
...
\newpage
<<waveform_capno, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
<<r neo_waveform_capno, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
<<r ped_waveform_capno, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=

plotData <- metricData[metricData$ped_adv_airway_cases > 0 &
                           metricData$ped_adv_airway_capno <= metricData$ped_adv_airway_cases,
...
\newpage
<<confirmed_tt, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=


plotData <- metricData[metricData$adv_airway_tt_cases > 0 &
                           metricData$adv_airway_tt_confirmed <= metricData$adv_airway_tt_cases,
...
\newpage
\section*{Intubation}
<<r first_attempt_success_neo,  eval=FALSE, fig.path="figures/", include=TRUE, fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<DASH1A_neo, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<r first_attempt_success_ped, eval=FALSE, fig.path="figures/", include=TRUE, fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<r DASH1A_ped, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<r first_attempt_success_adult, eval=FALSE, fig.path="figures/", include=TRUE, fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<DASH1A_adult, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<r RSI_compliance, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
<<pain_assessment, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<hems_over_triage, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<neonatal_hypothermia, fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<bedside_stemi, fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<scene_stemi, fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
rate.overall <- weighted.mean(scene_overall$mean_scene_stemi, scene_overall$stemi_cases, na.rm=TRUE)
...
\newpage
<<ecg_stemi, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<bg_check, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<htn_hem_stroke, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<hem_shock_managed, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<bp_aortic, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<med_equip_failure, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<ade, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<nearmiss, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<sre, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<device_dislogement, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
...
\newpage
<<med_error, include=TRUE,  fig.path="figures/", fig.height=8, eval=TRUE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE>>=
