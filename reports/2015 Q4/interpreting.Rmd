...
In the example above, transport team mobilization times are shown for two different programs. On the left, the program has a non-random decrease in mobilization times, which may be the result of an improvement initiative or some other cause. On the right, there appears to be a seasonal pattern. 
