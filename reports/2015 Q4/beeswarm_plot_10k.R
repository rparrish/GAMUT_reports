...
beeswarm_plot10k <- function(data = NULL, title = "GAMUT Metric title", program = program_name, ...)  {
    ...
    if(nrow(indiv_data) > 0) {
     ...
     arrows(x0 = indiv_points$conf.int[1]*10000, y0=1.1, #1.3,
            x1 = indiv_points$conf.int[2]*10000, y1=1.1, #1.3,
