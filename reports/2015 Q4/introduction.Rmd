...
The growth of the GAMUT Database has been steady - with now over `r overview$enrolled` programs enrolled and `r overview$total_contacts` patient contacts cataloged in 2015.  The GAMUT QI Collaborative oversight committee - consisting of AMPA, AAP-SOTM, and other stakeholders, has been actively guiding growth of the Database and QI Collaborative. This group has helped facilitate new studies using the database, discussions around data protection, and metric re-evaluation and improvement.  
...
![alt text](figures/examples/example_dashboard.png)  ![alt text](figures/examples/example_dashboard2.png) 
