...
\centering
![](figures/examples/example_runchart.png)
...
```{r vent_adv_airway, fig.height = 2.5, fig.path="figures/", include=TRUE, eval=TRUE, message=FALSE, echo =FALSE, warning=FALSE, error=FALSE}
plotData <- pd(dag=dag, 
...
```{r neo_vent_adv_airway, fig.height = 2.5, fig.path="figures/", include=TRUE, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE, error=FALSE}
