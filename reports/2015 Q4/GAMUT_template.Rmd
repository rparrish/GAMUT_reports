...
beeswarm(plotData$num/plotData$den, 
...
overall_mean <- sum(plotData$num)/sum(plotData$den)
...
axis(1, at=pretty(plotData$num/plotData$den), 
     lab=paste0(pretty(plotData$num/plotData$den) * 100, "%"), 
     las=TRUE)
