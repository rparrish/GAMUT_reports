...
#' driver_2020Q4.R
#'
#' generates a 2020 Q4 GAMUT report for each data access group
#'
#' Rmarkdown version
...
setwd("~/Projects/gamut_reports/reports/2020 Q4")
...
for(org in organizations$org) {
    ...
    rmarkdown::render("GAMUT_DAG_template.Rmd",
                      ...
                      clean = TRUE,
                      envir = new.env(),
                      output_file =paste0('GAMUT_2020Q2_', filename, '_Org_Summary.pdf')
