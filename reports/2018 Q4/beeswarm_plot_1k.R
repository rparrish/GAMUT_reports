...
beeswarm_plot1k <- function(data = NULL, title = "GAMUT Metric title", program = program_name, ...)  {
    ...
    # add text labels
    shadowtext(x = indiv_points$estimate*1000,
               y = 1.30,
               paste0("  ", round(indiv_points$estimate*1000,1),scale_text),
               col = "blue",
               bg = "white",
               cex = 1,
               r = 0.2)
